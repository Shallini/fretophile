...
?>                  
                    <p>Title: <?php echo $query->highlightMatches(CHtml::encode($result->model)); ?></p>
                    <p>Year: <?php echo $query->highlightMatches(CHtml::encode($result->year)); ?></p>
                    <p>Link: <?php //echo CHtml::link($query->highlightMatches(CHtml::encode($result->link)), CHtml::encode($result->link)); ?></p>
                    <p>Content: <?php echo $query->highlightMatches(CHtml::encode($result->description)); ?></p>
                    <hr/>
                <?php endforeach; ?>
