...
Galleria = function() {
    ...
    var lightbox = this._lightbox = {
        ...
        rescale: function(event) {
            ...
            // calculate
             var width = Math.min( $win.width()-54, lightbox.width ),
                height = Math.min( $win.height()-81, lightbox.height ),
                ratio = Math.min( width / lightbox.width, height / lightbox.height ),
                destWidth = Math.round( lightbox.width * ratio ) + 54,
                destHeight = Math.round( lightbox.height * ratio ) + 81,
                to = {
                    width: destWidth,
                    height: destHeight,
